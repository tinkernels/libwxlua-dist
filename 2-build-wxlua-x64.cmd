...
set WXWIDGETS_LIBDIR=%~dp0build-wxWidgets\x64\lib\vc_x64_dll
...
for %%i in (
    ...
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DCMAKE_INSTALL_PREFIX="%~dp0build-wxlua\x64\install"
    ...
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DwxLua_LUA_INCLUDE_DIR="%~dp0luajit-dist-winx64\include"
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DwxLua_LUA_LIBRARY="%~dp0luajit-dist-winx64\lib\lua51.lib"
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DwxLua_LUA_LIBRARY_USE_BUILTIN=FALSE
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DwxWidgets_ROOT_DIR="%~dp0build-wxWidgets\x64"
    ...
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -B "%~dp0build-wxlua\x64"
...
@REM devenv build-wxlua\x64\wxLua.sln /Build "MinSizeRel|x64"
@REM devenv build-wxlua\x64\wxLua.sln /Build "MinSizeRel|x64" /project INSTALL
devenv build-wxlua\x64\modules\wxLuaModules.sln /Build "MinSizeRel|x64"
devenv build-wxlua\x64\modules\wxLuaModules.sln /Build "MinSizeRel|x64" /project INSTALL
