...
for %%i in (
    ...
    set TK_CUSTOM_CONFIGURE_OPTS=-DBUILD_SHARED_LIBS=TRUE -DBUILD_OUTPUT_DIRECTORY_ARCHIVE=lib -DBUILD_OUTPUT_DIRECTORY_LIBRARY=lib
    set TK_CUSTOM_CONFIGURE_OPTS=!TK_CUSTOM_CONFIGURE_OPTS! -DBUILD_OUTPUT_DIRECTORY_RUNTIME=bin
