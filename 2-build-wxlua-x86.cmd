...
set TK_CMake_Install_Prefix=%~dp0wxlua-dist-win32
set TK_CMake_Build_Dir=%~dp0build-wxlua\x86
...
@REM devenv "%TK_CMake_Build_Dir%\wxLua.sln" /Build "MinSizeRel|Win32"
@REM devenv "%TK_CMake_Build_Dir%\wxLua.sln" /Build "MinSizeRel|Win32" /project INSTALL
devenv "%TK_CMake_Build_Dir%\modules\wxLuaModules.sln" /Build "MinSizeRel|Win32"
devenv "%TK_CMake_Build_Dir%\modules\wxLuaModules.sln" /Build "MinSizeRel|Win32" /project INSTALL