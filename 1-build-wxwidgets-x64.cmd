...
%_PSC% Copy-Item -Path "%TK_Build_Dir%\3rdparty\webview2\build\native\x64\*.dll" -Destination "%TK_Build_Dir%\lib\vc_x64_dll" -Recurse -Force
goto __END
...
@REM set CMAKE_GENERATOR_PARAM=%CMAKE_GENERATOR_PARAM% -A x64

@REM echo=
@REM echo CMAKE_GENERATOR_PARAM: %CMAKE_GENERATOR_PARAM%

@REM set TK_CMake_Install_Prefix=%~dp0wxWidgets-dist-winx64
...
@REM devenv "%TK_Build_Dir%\wxWidgets.sln" /Build "Release|x64"
@REM devenv "%TK_Build_Dir%\wxWidgets.sln" /Build "Release|x64" /Project INSTALL
