...
set TK_CMake_Install_Prefix=%~dp0wxWidgets-dist-winx64
...
devenv "%TK_Build_Dir%\wxWidgets.sln" /Build "Release|x64"
devenv "%TK_Build_Dir%\wxWidgets.sln" /Build "Release|x64" /Project INSTALL
